...
import com.desitum.library.widgets.PopupMenu;
...
public class KodyWorld implements InputProcessor {
    ...
    /**
     ...
     if (!clickedOnWidget) {
     try {
     for (Widget widget : com.desitum.library.widgets) {
     ...
     com.desitum.library.widgets.remove(widget);
     }
     widgetsToRem.clear();

     for (Widget widget : widgetsToAdd) {
     com.desitum.library.widgets.add(widget);
     }
     widgetsToAdd.clear();
     }
     ...
     return com.desitum.library.widgets;
     }
